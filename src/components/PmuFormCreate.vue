      ...
      <div class="xs:relative space-y-3 xs:space-y-0">
        ...
        <div class="relative rounded-lg shadow-3 bg-white border border-grey-300 p-4 lg:py-6 lg:px-8">
          <div class="space-y-4">
            ...
            <div class="flex justify-start sm:justify-end ">
              <Button class="text-red hover:bg-red/10 px-2 gap-x-1.5 inline-flex items-center justify-end" type="button"
        ...
        <div class="relative rounded-lg shadow-3 bg-white border border-grey-300 space-y-3 p-4 lg:py-6 lg:px-8 hidden">
          <div class="flex items-center">
            <div class="relative flex-1">
              <Input id="formDescription" type="text" :label-text="'Form description'"
                :placeholder="'Please read the folowing'" />
            </div>
            <div class="pt-5 flex pl-3 gap-0.5">

              <Button class="text-red hover:bg-red/10 mv:px-3 gap-x-1.5 inline-flex items-center ml-auto justify-end"
                :btn-no-border="true" :btn-primary="false">
                <TrashIcon class="w-4" />
              </Button>
            </div>
        ...
        <div
          ...
          <div class="p-1.5 flex xs:flex-col gap-2 ">
            ...
            <Button class="text-grey-700 hover:bg-red/10 px-2 flex items-center justify-end" :btn-no-border="true"
              :btn-primary="false">
            ...
            <div class="md:grid md:grid-cols-12 gap-5 xl:gap-10 2xl:gap-20 flex flex-col">
              ...
              <div class="md:col-span-9">
                <div class="relative space-y-4">
                  ...
                  <!-- <div class="space-y-3" v-for="(repq, ind) in repQuestions" :key="ind">
                    <Textarea name="question" rows="4" id="question" :label-text="`Question ${ind+1}`" />
                  ...
                  <!-- Repeat Question -->
                  <!-- <div class="flex items-center cursor-pointer" @click="repQuestions++">
