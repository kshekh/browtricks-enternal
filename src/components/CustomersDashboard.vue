<template>
   <div class="relative flex flex-col w-full flex-1">
    ...
    <div v-else class="px-4 py-3 md:p-5 xl:px-14 xl:py-12 flex-1 flex flex-col"> 
      <h1 class="text-3xl sm:text-5xl font-bold leading-none text-gray-800 mb-5 pt-3">               
        Customers
        </h1>
        ...
        <div class="setup-guide-area p-10 px-4 ">
          <div class="flex flex-col justify-center text-center space-y-10 max-w-xs mx-auto">
            ...
            <div class="flex flex-col space-y-10">
              <div class="space-y-4">
              <h2 class="text-3xl sm:text-4xl font-bold text-gray-800 leading-none">Add a customer</h2>
